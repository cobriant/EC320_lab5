...
# Run this code to load `students` into your environment.
students <- read_csv(
...
# so reflect on recipes 1 and 2. Challenge yourself to memorize the syntax by
# typing it out without looking at the recipe.
